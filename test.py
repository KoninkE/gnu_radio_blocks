...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.variable_constellation_0.set_npwr(0)
        self.samp_rate = samp_rate = 81000000
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(4, 1.025M, , 32, 16, 1.5, 1)
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(1.025M, 3, False)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 9000000, 1, 0, 0)
